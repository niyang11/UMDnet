...
# 设置保存路径
save_folder = "/home/project/ny/pythonProject/Wave_Unet/best_model/best_model_dnunet_20000SS/"
save_folder_loss = '/home/project/ny/pythonProject/Wave_Unet/loss/loss_DN_20000SS'
...
# 创建模型
wave_unet = Modeldnwave(n_layers=12, channels_interval=24).cuda()
...
patience = 20
best_loss = float('inf')
best_model_path = os.path.join(save_folder, 'best_model_DN_20000SS_250331.pth')
no_improve_epochs = 0
...
# 保存训练和验证损失数据到HDF5文件中
loss_file_path = os.path.join(save_folder_loss, 'model_DN_20000SS.h5')
